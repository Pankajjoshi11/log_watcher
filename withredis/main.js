...
const { createWSHub } = require('./src/realTime/ws');           // your WS hub
const { FileTailer }  = require('./src/core/tailer');              // your offset tailer
const { readLastNLines } = require('./src/core/lastN');            // fallback seed
const { connectRedis, publishLine, subscribe, fetchSeed } =
  require('./src/realTime/redisBus');

const PORT   = process.env.PORT || 3000;
const ROOT   = path.resolve(__dirname, '..', 'log watcher','withredis');
